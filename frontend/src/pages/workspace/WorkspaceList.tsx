            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <form className="space-y-4 pt-4" onSubmit={handleCreate}>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-violet-600 hover:bg-violet-700 h-11 font-bold"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filtered.map((workspace) => (
              <Card
                ...
                className="group cursor-pointer border-zinc-200 hover:border-violet-400 transition-all hover:shadow-lg hover:shadow-violet-500/5 overflow-hidden flex flex-col h-"
              >
